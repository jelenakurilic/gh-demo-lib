...
[![CI Build](https://github.com/jelenakurilic/gh-demo-lib/actions/workflows/ci.yml/badge.svg)](https://github.com/jelenakurilic/gh-demo-lib/actions/workflows/ci.yml)
...
repositories {
    ...
    maven {
        name = "GitHubPackages"
        url = uri("https://maven.pkg.github.com/jelenakurilic/gh-demo-lib")
        credentials {
...
## Development
### Setup (First time)
1. Clone the repository: `git clone git@github.com:jelenakurilic/gh-demo-lib.git`
